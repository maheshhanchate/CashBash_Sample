...
{
    public partial class PDPullEntity
    {
        ...
        public Nullable<int> TOTL_PNTS_QY { get; set; }
        public Nullable<int> PLLS_WON_QY { get; set; }
        public Nullable<int> TRPS_WON_QY { get; set; }
        public Nullable<int> TRPS_PRCH_QY { get; set; }
        public Nullable<int> BUY_UP_QY { get; set; }
        public Nullable<int> BUY_UP_PERCENTAGE { get; set; }
        public Nullable<decimal> PRCH_AMT { get; set; }
